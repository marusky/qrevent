...
class AttendeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attendee" do
    assert_difference('Attendee.count') do
      post attendees_url, params: { attendee: { email: @attendee.email, name: @attendee.name, phone_number: @attendee.phone_number } }
    end
  ...
  test "should update attendee" do
    patch attendee_url(@attendee), params: { attendee: { email: @attendee.email, name: @attendee.name, phone_number: @attendee.phone_number } }
